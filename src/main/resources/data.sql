--Datos de prueba
insert into Customer (id, first_name, last_name, address, city) values (1,
'Marcos', 'Gutierrez', 'la buena direccion 123', 'CABA');
insert into Customer (id, first_name, last_name, address, city) values (2,
                                                                           'Hernan', 'Toledo', 'falsa 456', 'CABA');
insert into Customer (id, first_name, last_name, address, city) values (3,
...
insert into Shipping_item (id, shipping_id, product_id, product_count) values (1,
                                                                               1, 1, 5);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (2,
                                                                               1, 2, 2);

insert into Shipping_item (id, shipping_id, product_id, product_count) values (3,
                                                                               1, 3, 1);
insert into Shipping (id, customer_id, state, send_date, arrive_date, priority)
values (2, 2, 'En camino', CURRENT_DATE - 5, null, 2);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (4,
                                                                               2, 4, 6);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (5,
                                                                               2, 5, 2);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (6,
                                                                               2, 6, 2);
insert into Shipping (id, customer_id, state, send_date, arrive_date, priority)
values (3, 1, 'Inicial', CURRENT_DATE, null, 2);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (7,
                                                                               3, 4, 1);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (8,
                                                                               3, 5, 2);
insert into Shipping (id, customer_id, state, send_date, arrive_date, priority)
values (4, 3, 'Cancelado', CURRENT_DATE - 4, null, 2);
insert into Shipping_item (id, shipping_id, product_id, product_count) values (9,
                                                                               4, 3, 1);